<template>
    ...
    <!-- Begin contents -->
    <div class="bg-parallax-1 -mb-36 flex 2xl:block xl:block lg:block md:hidden sm:hidden xs:hidden">
        <div class="w-8/12 mx-auto px-1.5 py-28">
            <div class="h-52 bg-white mb-28 border rounded">
                <div class="w-full">
